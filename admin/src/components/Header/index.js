...
import { MdMenuOpen, MdOutlineMenu, MdOutlineLightMode, MdNightlightRound, MdDarkMode } from "react-icons/md";
...
const Header = () => {
  ...
  const handleOpenNotificationsDrop = () => setIsOpenNotificationDrop(true);
              ...
              <div className="dropdownWrapper position-relative">
                ...
                >
                  ...
                  <div className="scroll">
                    {[...Array(6)].map((_, idx) => (
                      <MenuItem onClick={handleCloseMyAccDrop} key={idx}>
